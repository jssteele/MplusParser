...
# Version: 0.3b
#---------------------------------# 
# This version currenty does not
# handle | style syntax. 
# you will need to write out what 
# you mean.
#---------------------------------# 

# for easy file creation... not just for HTML anymore
use HTML::Template;

# currently this assumes data in csv format... but why would you use anything else right?
# -jss
sub new{
	my $class = shift;
	my $file = shift || 0;
...
# "You only record your first album once" -Lapdog
1;
